...
import { Award, ClipboardCheck, ListChecks, Pencil, Users } from "lucide-react";

export function EventRowActions({ id, title, shortlist }: { id: string; title: string; shortlist?: boolean }) {
